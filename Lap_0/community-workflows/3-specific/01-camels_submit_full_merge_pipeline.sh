...
daily_input_dir="/home/zelalem/scratch/cantrans-models/camels-casr3p2-easymore-outputs"
yearly_output_dir="/home/zelalem/scratch/cantrans-models/camels-casr3p2-easymore-outputs/easymore-outputs-yearly"
final_output_dir="/home/zelalem/scratch/cantrans-models/camels-casr3p2"

mkdir -p "$yearly_output_dir" "$final_output_dir" "logs_camels-casr"
...
#SBATCH --output=logs_camels_casr/merge_daily_%A_%a.out
#SBATCH --error=logs_camels_casr/merge_daily_%A_%a.err
...
files=\$(find "${daily_input_dir}" -maxdepth 1 -type f -name "${domain}_\${year}*.nc" | sort)
...
#SBATCH --mem=64G
#SBATCH --time=6:00:00
#SBATCH --output=logs_camels_casr/final_merge.out
#SBATCH --error=logs_camels_casr/final_merge.err
