...
# ?? USER CONFIGURATIONS
# ------------------------
domain="remapped_remapped_rdrs"
start_year=1980
end_year=2018

# Input/output directories
daily_input_dir="/home/zelalem/scratch/cantrans-models/rdrs-easymore-outputs"
yearly_output_dir="/home/zelalem/scratch/cantrans-models/rdrs-easymore-outputs/easymore-outputs-yearly"
final_output_dir="/home/zelalem/scratch/cantrans-models/rdrs"

mkdir -p "$yearly_output_dir" "$final_output_dir" "logs_rdrs"

# ------------------------
# ?? SCRIPT PATHS
# ------------------------
daily_script="rdrs_merge_daily_array.sh"
final_script="rdrs_merge_yearly_final.sh"
...
#SBATCH --output=logs_rdrs/merge_daily_%A_%a.out
#SBATCH --error=logs_rdrs/merge_daily_%A_%a.err
