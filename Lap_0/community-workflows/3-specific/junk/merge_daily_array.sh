...
output_file="/home/zelalem/scratch/cantrans-models/era5land-easymore-outputs/easymore-outputs-yearly/remapped_remapped_era5l.${year}.nc"

files=$(find "/home/zelalem/scratch/cantrans-models/era5land-easymore-outputs" -maxdepth 1 -type f -name "remapped_remapped_era5l.${year}*.nc" | sort)
