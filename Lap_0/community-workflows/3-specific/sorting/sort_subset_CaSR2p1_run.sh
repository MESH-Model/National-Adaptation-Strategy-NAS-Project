...
#SBATCH --output=logs2/output_%A_%a.out
#SBATCH --error=logs2/error_%A_%a.err
...
input_climate_nc = f'/scratch/zelalem/CanTrans-models/easymore-outputs/batches_CaSRv2p1/batch_{job_index}.nc'
output_climate_nc = f'/scratch/zelalem/CanTrans-models/easymore-outputs/temp_v2p1/batch_CaSRv2p1_{job_index}.nc'
